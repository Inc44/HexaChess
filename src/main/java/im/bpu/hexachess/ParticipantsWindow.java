...
public class ParticipantsWindow {
    ...
    private void initialize() {
        ...
        Thread.ofVirtual().start(() -> {
            List<Player> players = API.getTournamentParticipants(targetTournament.getTournamentId());
            ...
            Platform.runLater(() -> {
                ...
                if (players.isEmpty()) {
                    ...
                    for (Player p : players) {
                        ...
                        row.setStyle("-fx-padding: 10; -fx-background-color: white; -fx-background-radius: 5;");
